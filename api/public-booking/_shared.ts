...
const publicErrorCodes = [
  'PUBLIC_AVAILABILITY_INVALID_DATE',
  'PUBLIC_AVAILABILITY_INVALID_TENANT',
  'PUBLIC_AVAILABILITY_INVALID_BARBER',
  'PUBLIC_AVAILABILITY_INVALID_SERVICE',
  'PUBLIC_AVAILABILITY_TIMEZONE_REQUIRED',
  'PUBLIC_AVAILABILITY_SLOT_STEP_REQUIRED',
  'PUBLIC_AVAILABILITY_INVALID_BUSINESS_HOURS',

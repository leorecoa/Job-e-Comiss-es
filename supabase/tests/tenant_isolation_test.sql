...
values
  ('60000000-0000-4000-8000-000000000001', 'Client Alpha', '0000000000', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, (date_trunc('day', now()) + interval '10 hours') + interval '7 days', (date_trunc('day', now()) + interval '10 hours') + interval '7 days 30 minutes', 'scheduled', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1'),
  ('60000000-0000-4000-8000-000000000002', 'Client Beta', '0000000000', '22222222-2222-4222-8222-222222222222', 'Barber Beta', '44444444-4444-4444-8444-444444444444', 'Service Beta', 55, (date_trunc('day', now()) + interval '10 hours') + interval '8 days', (date_trunc('day', now()) + interval '10 hours') + interval '8 days 30 minutes', 'scheduled', 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb2'),
  ('60000000-0000-4000-8000-000000000003', 'Client Alpha Two', '0000000000', '55555555-5555-4555-8555-555555555555', 'Barber Alpha Two', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, (date_trunc('day', now()) + interval '10 hours') + interval '9 days', (date_trunc('day', now()) + interval '10 hours') + interval '9 days 30 minutes', 'scheduled', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1');
...
select throws_ok($test$select * from public.update_owner_appointment('60000000-0000-4000-8000-000000000002', 'Client Beta', '0000000000', '22222222-2222-4222-8222-222222222222', 'Barber Beta', '44444444-4444-4444-8444-444444444444', 'Service Beta', 55, null, (date_trunc('day', now()) + interval '10 hours') + interval '8 days', (date_trunc('day', now()) + interval '10 hours') + interval '8 days 30 minutes', 'confirmed', null)$test$, 'P0001'::char(5), 'OWNER_APPOINTMENT_NOT_FOUND', 'owner update cannot target another tenant');
...
reset role;
select throws_ok($test$insert into public.appointments (client_name, client_phone, barber_id, barber_name, service_id, service_type, service_value, start_at, end_at, status, barbershop_id) values ('Cross Barber', '0000000000', '22222222-2222-4222-8222-222222222222', 'Barber Beta', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, (date_trunc('day', now()) + interval '10 hours') + interval '10 days', (date_trunc('day', now()) + interval '10 hours') + interval '10 days 30 minutes', 'scheduled', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1')$test$, 'P0001'::char(5), 'APPOINTMENT_INVALID_BARBER', 'writer rejects cross-tenant barber before FK');
select throws_ok($test$insert into public.appointments (client_name, client_phone, barber_id, barber_name, service_id, service_type, service_value, start_at, end_at, status, barbershop_id) values ('Cross Service', '0000000000', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '44444444-4444-4444-8444-444444444444', 'Service Beta', 55, (date_trunc('day', now()) + interval '10 hours') + interval '11 days', (date_trunc('day', now()) + interval '10 hours') + interval '11 days 30 minutes', 'scheduled', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1')$test$, 'P0001'::char(5), 'APPOINTMENT_INVALID_SERVICE', 'writer rejects cross-tenant service before FK');
...
set local role service_role;
select throws_ok($test$select public.create_public_appointment('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'Public Repeat', '9191111111', (date_trunc('day', now()) + interval '10 hours') + interval '31 days', (date_trunc('day', now()) + interval '10 hours') + interval '31 days 30 minutes', null)$test$, 'P0001'::char(5), 'PUBLIC_APPOINTMENT_RATE_LIMITED', 'public RPC rate limits the same tenant and phone for 60 seconds');
select lives_ok($test$select public.create_public_appointment('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'Other Phone', '9191111112', (date_trunc('day', now()) + interval '10 hours') + interval '32 days', (date_trunc('day', now()) + interval '10 hours') + interval '32 days 30 minutes', null)$test$, 'another phone is not rate limited');
select lives_ok($test$select public.create_public_appointment('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb2', '22222222-2222-4222-8222-222222222222', '44444444-4444-4444-8444-444444444444', 'Other Tenant', '9191111111', (date_trunc('day', now()) + interval '10 hours') + interval '33 days', (date_trunc('day', now()) + interval '10 hours') + interval '33 days 30 minutes', null)$test$, 'same phone in another tenant is not rate limited');
select throws_ok($test$select public.create_public_appointment('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'Public Conflict', '9191111113', (date_trunc('day', now()) + interval '10 hours') + interval '30 days', (date_trunc('day', now()) + interval '10 hours') + interval '30 days 30 minutes', null)$test$, 'P0001'::char(5), 'PUBLIC_APPOINTMENT_SLOT_CONFLICT', 'public RPC normalizes slot conflicts');
select throws_ok($test$select public.create_public_appointment('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', '22222222-2222-4222-8222-222222222222', '33333333-3333-4333-8333-333333333333', 'Cross Tenant', '0000000000', (date_trunc('day', now()) + interval '10 hours') + interval '31 days', (date_trunc('day', now()) + interval '10 hours') + interval '31 days 30 minutes', null)$test$, 'P0001'::char(5), 'PUBLIC_APPOINTMENT_INVALID_BARBER', 'public RPC rejects cross-tenant barber');
...
values
  ('Active Limit One', '9191111114', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, (date_trunc('day', now()) + interval '10 hours') + interval '40 days', (date_trunc('day', now()) + interval '10 hours') + interval '40 days 30 minutes', 'scheduled', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', now() - interval '2 minutes'),
  ('Active Limit Two', '9191111114', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, (date_trunc('day', now()) + interval '10 hours') + interval '41 days', (date_trunc('day', now()) + interval '10 hours') + interval '41 days 30 minutes', 'confirmed', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', now() - interval '2 minutes'),
  ('Active Limit Three', '9191111114', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, (date_trunc('day', now()) + interval '10 hours') + interval '42 days', (date_trunc('day', now()) + interval '10 hours') + interval '42 days 30 minutes', 'scheduled', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', now() - interval '2 minutes'),
  ('Ignored Cancelled', '9191111115', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, (date_trunc('day', now()) + interval '10 hours') + interval '44 days', (date_trunc('day', now()) + interval '10 hours') + interval '44 days 30 minutes', 'cancelled', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', now() - interval '2 minutes'),
  ('Ignored Completed', '9191111115', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, (date_trunc('day', now()) + interval '10 hours') + interval '45 days', (date_trunc('day', now()) + interval '10 hours') + interval '45 days 30 minutes', 'completed', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', now() - interval '2 minutes'),
  ('Ignored No Show', '9191111115', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, (date_trunc('day', now()) + interval '10 hours') + interval '46 days', (date_trunc('day', now()) + interval '10 hours') + interval '46 days 30 minutes', 'no_show', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', now() - interval '2 minutes');

set local role service_role;
select throws_ok($test$select public.create_public_appointment('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'Active Limit Four', '9191111114', (date_trunc('day', now()) + interval '10 hours') + interval '43 days', (date_trunc('day', now()) + interval '10 hours') + interval '43 days 30 minutes', null)$test$, 'P0001'::char(5), 'PUBLIC_APPOINTMENT_ACTIVE_LIMIT', 'fourth future active appointment is blocked');
select lives_ok($test$select public.create_public_appointment('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'Ignored Statuses Allowed', '9191111115', (date_trunc('day', now()) + interval '10 hours') + interval '47 days', (date_trunc('day', now()) + interval '10 hours') + interval '47 days 30 minutes', null)$test$, 'completed cancelled and no-show do not count toward active limit');
...
values
  ('80000000-0000-4000-8000-000000000001', 'Cancelled Finance', '0000000000', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, 50, (date_trunc('day', now()) + interval '10 hours') + interval '60 days', (date_trunc('day', now()) + interval '10 hours') + interval '60 days 30 minutes', 'cancelled', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1'),
  ('80000000-0000-4000-8000-000000000002', 'Repair Finance', '0000000000', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, 50, (date_trunc('day', now()) + interval '10 hours') + interval '61 days', (date_trunc('day', now()) + interval '10 hours') + interval '61 days 30 minutes', 'completed', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1'),
  ('80000000-0000-4000-8000-000000000003', 'Rollback Finance', '0000000000', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, 50, (date_trunc('day', now()) + interval '10 hours') + interval '62 days', (date_trunc('day', now()) + interval '10 hours') + interval '62 days 30 minutes', 'scheduled', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1'),
  ('80000000-0000-4000-8000-000000000004', 'No Show Finance', '0000000000', '11111111-1111-4111-8111-111111111111', 'Barber Alpha', '33333333-3333-4333-8333-333333333333', 'Service Alpha', 40, 50, (date_trunc('day', now()) + interval '10 hours') + interval '63 days', (date_trunc('day', now()) + interval '10 hours') + interval '63 days 30 minutes', 'no_show', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1');

    ...
    <div className="animate-slide-in space-y-6">
        ...
        <div className="flex gap-3 w-full md:w-auto items-center justify-end">
          ...
          <div className="relative flex-grow md:flex-grow-0">
            ...
            <input
              ...
              className="w-full md:w-40 bg-gray-900/50 border border-gray-700 text-white text-sm rounded-xl focus:ring-2 focus:ring-gold-500 focus:border-transparent block pl-10 p-2.5 [&::-webkit-calendar-picker-indicator]:filter [&::-webkit-calendar-picker-indicator]:invert"
            />
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatsCard
          ...
          colorClass="bg-gradient-to-br from-blue-900/40 to-gray-900/40 border-blue-500/30 text-blue-400"
        />
        <StatsCard
          title="Vales / Despesas"
          value={formatCurrency(monthlyData.totalVales)}
          icon={<MinusCircle size={20} />}
          colorClass="bg-gradient-to-br from-red-900/40 to-gray-900/40 border-red-500/30 text-red-400"
        />
        <StatsCard
          ...
          colorClass="bg-gradient-to-br from-gold-500/20 to-gray-900/40 border-gold-500/50 text-gold-500"
        />
      </div>
      ...
      {monthlyData.teamBreakdown.length > 0 && (
        <div className="glass-card rounded-2xl overflow-hidden">
          <div className="p-4 border-b border-white/5 bg-white/5 flex justify-between items-center">
            ...
            <span className="text-[10px] text-gray-400 bg-black/30 px-2 py-1 rounded border border-white/10">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-white/5">
                {monthlyData.teamBreakdown.map((barber) => {
                  ...
                  return (
                    <tr key={barber.name} className="hover:bg-white/5 transition-colors">
